...
Este directorio almacena la información utilizada para garantizar la trazabilidad de los experimentos realizados durante el desarrollo del proyecto.
...
\item archivos intermedios;

\item métricas obtenidas durante las pruebas;

\item registros utilizados para validar los experimentos;

\item configuraciones empleadas durante la ejecución de los experimentos.
...
\item trazabilidad de los experimentos realizados;
...
En conjunto, esta organización proporciona una base sólida para el desarrollo de aplicaciones de computación concurrente y distribuida. La separación entre código fuente, datos, documentación y resultados experimentales facilita tanto el mantenimiento del proyecto como la comparación objetiva entre las diferentes implementaciones desarrolladas. Asimismo, la incorporación de mecanismos de automatización y trazabilidad contribuye a garantizar la reproducibilidad de los experimentos, aspecto fundamental en proyectos de computación de alto rendimiento y evaluación del desempeño.