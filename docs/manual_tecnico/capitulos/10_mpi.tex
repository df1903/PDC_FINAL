...
Worker 1 \hspace{0.3cm}
Worker 2 \hspace{0.3cm}
Worker 3
...
\parbox[c][8cm][c]{0.85\textwidth}{
\centering
Insertar captura de compilación MPI.
}}
\caption{Compilación utilizando MPI.}
\end{figure}
...
\parbox[c][8cm][c]{0.85\textwidth}{
\centering
Insertar captura de ejecución MPI.
}}
\caption{Resultados experimentales MPI.}
\end{figure}
