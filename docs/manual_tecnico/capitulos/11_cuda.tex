...
caption={Tamaño de bloque utilizado por el kernel CUDA},
label={lst:block_size}]
...
caption={Configuración de Grid y Blocks en PyCUDA},
label={lst:grid_configuration}]
block = (256,1,1)
...
\begin{lstlisting}[language=Python,
caption={Pseudocódigo general de la implementación CUDA},
label={lst:cuda_pseudocode}]
copiar_datos_gpu()
...
La Figura \ref{fig:benchmark_cuda} presenta los resultados del benchmark obtenido durante los experimentos realizados con la implementación PyCUDA.

\begin{figure}[H]
\centering
\includegraphics[width=.95\textwidth, height=0.45\textheight, keepaspectratio]
{figuras/capturas/benchmark.png}
\caption{Benchmark de la implementación PyCUDA.}
\label{fig:benchmark_cuda}
\end{figure}

La Figura \ref{fig:pycuda_colab} presenta los resultados experimentales obtenidos al ejecutar la implementación sobre Google Colab.

\begin{figure}[H]
\centering
\includegraphics[width=.95\textwidth, height=0.45\textheight, keepaspectratio]
{figuras/capturas/pycuda_colab.png}
\caption{Resultados experimentales de la implementación PyCUDA ejecutada en Google Colab.}
\label{fig:pycuda_colab}
\end{figure}
